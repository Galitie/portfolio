...
export const metadata = {
  ...
  description: 'Template Blog Page',
}
    ...
    <SimpleLayout>
      <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
        ...
        <p className="mt-6 text-xl leading-8 text-zinc-400">
          This is the intro / TLDR section that people skim before they skim the
          entire article. Great for hooking folks and also just a cool thing to
          do.
        </p>
